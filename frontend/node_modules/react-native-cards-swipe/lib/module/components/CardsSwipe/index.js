...
const CardsSwipe = /*#__PURE__*/forwardRef(({
  cards,
  renderCard,
  loop = true,
  ...
  const onChangeSwipeDirection = useCallback(direction => {
    onSwipeChangeDirection(direction);
  }, [onSwipeChangeDirection]);
  const onEndSwipe = useCallback(() => {
    onSwipeEnd(index);
  }, [index, onSwipeEnd]);
  const onCardSwiped = useCallback(right => {
    setLock(true);
    onSwiped(index);
  ...
  const renderNoMoreCardsContainer = () => {
    if (noMoreCards) {
      return /*#__PURE__*/React.createElement(View, null, renderNoMoreCard());
    }
  ...
  const style = useAnimatedStyle(() => {
    const factor = 1;
    const rotateZ = interpolate(x.value, [0, factor * horizontalThreshold], [0, rotationAngle]);
    return {
      elevation: 2,
      width: '100%',
      height: '100%',
  ...
  const lowerStyle = useAnimatedStyle(() => {
    const lowerCardScale = interpolate(x.value, [-horizontalThreshold, -0.01, 0, 0.01, horizontalThreshold], [1, lowerCardZoom, lowerCardZoom, lowerCardZoom, 1], Animated.Extrapolate.CLAMP);
    return {
      zIndex: -1,
      width: '100%',
      height: '100%',
  ...
  return /*#__PURE__*/React.createElement(View, {
  ...
  }, secondIndex >= 0 ? /*#__PURE__*/React.createElement(CardWrap, {
    key: secondIndex,
    pointerEvents: 'none',
    style: lowerStyle,
    cardContainerStyle
  }, renderCard(cards[secondIndex])) : null, index >= 0 ? /*#__PURE__*/React.createElement(SwipePan, {
    onSnap: onCardSwiped,
    ...
    y,
    originY
  }, /*#__PURE__*/React.createElement(CardWrap, {
    style,
    cardContainerStyle
  }, renderCard(cards[index]), /*#__PURE__*/React.createElement(Animated.View, {
  ...
  }, renderYep()), /*#__PURE__*/React.createElement(Animated.View, {
